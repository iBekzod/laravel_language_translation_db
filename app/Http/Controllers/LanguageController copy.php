...
class LanguageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('setup_configurations.languages.index', compact('languages'));
    }

    public function create(Request $request)
    {
        return view('setup_configurations.languages.create');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('setup_configurations.languages.language_view', compact('language','lang_keys','sort_search'));
    }

    public function edit($id)
    {
        $language = Language::findOrFail(decrypt($id));
        return view('setup_configurations.languages.edit', compact('language'));
    }
