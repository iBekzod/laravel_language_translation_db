...
class BusinessSettingsController extends Controller
{
    public function general_setting(Request $request)
    {
    	...
    	return view('setup_configurations.general_settings');
    }

    public function activation(Request $request)
    {
        // CoreComponentRepository::instantiateShopRepository();
    	return view('setup_configurations.activation');
    }

    public function social_login(Request $request)
    {
        // CoreComponentRepository::instantiateShopRepository();
        return view('setup_configurations.social_login');
    }

    public function smtp_settings(Request $request)
    {
        // CoreComponentRepository::instantiateShopRepository();
        return view('setup_configurations.smtp_settings');
    }

    public function google_analytics(Request $request)
    {
        // CoreComponentRepository::instantiateShopRepository();
        return view('setup_configurations.google_analytics');
    }

    public function google_recaptcha(Request $request)
    {
        // CoreComponentRepository::instantiateShopRepository();
        return view('setup_configurations.google_recaptcha');
    }

    public function facebook_chat(Request $request)
    {
        // CoreComponentRepository::instantiateShopRepository();
        return view('setup_configurations.facebook_chat');
    }

    public function payment_method(Request $request)
    {
        // CoreComponentRepository::instantiateShopRepository();
        return view('setup_configurations.payment_method');
    }

    public function file_system(Request $request)
    {
        // CoreComponentRepository::instantiateShopRepository();
        return view('setup_configurations.file_system');
    }
    ...
    {
    	return view('sellers.seller_verification_form.index');
    }
    ...
    public function vendor_commission(Request $request)
    {
        ...
        return view('sellers.seller_commission.index', compact('business_settings'));
    }
    ...
    public function shipping_configuration(Request $request){
        return view('setup_configurations.shipping_configuration.index');
    }
